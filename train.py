...
from model.pointnet import PointNetSeg, feature_transform_regularizer
...
class H5PointCloudDataset(Dataset):
    def __init__(self, h5_path):
        with h5py.File(h5_path, 'r') as f:
            self.points = f['points'][:]  # shape: (N, num_points, 3)
...
h5_path = '/home/internship/Documents/pointnet-hrc-vision/LabelledPoints.h5'
